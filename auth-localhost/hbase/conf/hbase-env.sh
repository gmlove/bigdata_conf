...
export CLIENT_CONF="/root/dev/projects/bigdata-auth-localhost/hbase/conf/jaas.conf"
export HBASE_SERVER_CONF="/root/dev/projects/bigdata-auth-localhost/hbase/conf/jaas.conf"
export HBASE_OPTS="-XX:+UseConcMarkSweepGC"
export AUTH_DEBUG_OPTS="-Dsun.security.krb5.debug=true -Dsun.security.spnego.debug=true"
