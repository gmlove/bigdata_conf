...
export SERVER_JVMFLAGS="-Xmx${ZK_SERVER_HEAP}m $SERVER_JVMFLAGS -Djava.security.auth.login.config=${ZOOBINDIR}/../conf/jaas.conf -Dzookeeper.skipACL=yes"

# default heap for zookeeper client
ZK_CLIENT_HEAP="${ZK_CLIENT_HEAP:-256}"
export CLIENT_JVMFLAGS="-Xmx${ZK_CLIENT_HEAP}m $CLIENT_JVMFLAGS -Djava.security.auth.login.config=${ZOOBINDIR}/../conf/client-jaas.conf"
